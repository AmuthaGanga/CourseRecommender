...
<div class="row">
    ...
    <br><br>
		...
		<h6 style="color:red;">${message}</h6>
			<div class="panel-heading">Enter the College Details
			</div>
			<div class="panel-body">
				<form id="identicalForm" name="myform" action="CreateCollegeController" method="post" >
					<div class="form-group">
						<label for="collegeName">College Name *</label>
						<input id="collegeName" name="collegeName" class="form-control vcheck" type="text" required >
						<span id="error_collegeName" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="city">City *</label>
						<input id="city" name="city" class="form-control vcheck" type="text" required >
						<span id="error_city" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="university">University *</label>
						<input id="university" name="university" class="form-control vcheck" type="text" required >
						<span id="error_university" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="website">Website *</label>
						<input type="text" id="website" name="website" class="form-control vcheck" required>
						<span id="error_website" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="accreditatedBy">Accreditated By *</label>
						<input type="text" id="accreditatedBy" name="accreditatedBy" class="form-control vcheck" required>
						<span id="error_accreditatedBy" class="text-danger"></span>
					</div>
					<div class="form-group">
						<label for="naacScore">NAAC Score *</label>
						<input type="text" id="naacScore" name="naacScore" class="form-control vcheck" required>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-12 col-xs-12"> 
							<select name="selectionList"  id="selectionList" class="form-control" multiple="multiple">
								<% if(null!=courses){ for(CourseInfo course : courses) { %>
						...
						<div class="col-md-4 col-sm-12 col-xs-12"> 
							<select name="selectedList"  id="selectedList" class="form-control vcheck" multiple="multiple" required>
								<%-- <% 
								String select[] = (String[])request.getParameterValues("selectedList");
								if(select != null && select.length != 0){
									for(int i = 0; i < select.length; i++){
										String optionValue = select[i]; %>
										<option selected="selected" value="<%=optionValue %>"><%=optionValue %></option>
								<% }	
								} %> --%>
							</select>
						</div>
					...
					<div class="row" >
						<div style="float: left; padding-left: 200px">
							<button id="submit" type="submit" value="submit" class="btn btn-primary" disabled="disabled">Add College</button>
						</div>
